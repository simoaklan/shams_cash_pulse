...
def get_columns():
    return [
        {"label": "رقم الصنف", "fieldname": "item_code", "fieldtype": "Link", "options": "Item", "width": 130},
        {"label": "الصنف", "fieldname": "item_name", "fieldtype": "Data", "width": 260},
        {"label": "الحالة", "fieldname": "status", "fieldtype": "Data", "width": 90},
        {"label": "الكمية المطلوبة", "fieldname": "to_order", "fieldtype": "Int", "width": 130},
        {"label": "بيع الفترة", "fieldname": "sold_period", "fieldtype": "Int", "width": 100},
        {"label": "معدّل/يوم", "fieldname": "daily_rate", "fieldtype": "Float", "width": 100, "precision": 2},
        {"label": "الطلب المتوقع", "fieldname": "expected_demand", "fieldtype": "Int", "width": 120},
        ...
        {"label": "التكلفة", "fieldname": "rate", "fieldtype": "Currency", "width": 110},
        {"label": "قيمة الطلب", "fieldname": "order_value", "fieldtype": "Currency", "width": 120},
        {"label": "التوضيح", "fieldname": "explanation", "fieldtype": "Data", "width": 350},
    ]